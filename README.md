...
7 урок. Серверный рендеринг
- jinja2. Шаблонизаторы с CSS-фреймворком
- Создание шаблонов с формами для входа, регистрации и прочего

8 урок. Аутентификация и авторизация
- Механизмы входа и авторизации
- Механизмы сессий (jwt-токены)
- Хэширование паролей (bcrypt)

9 урок. Тестирование сервисов. unittest+requests+pytest
- Пирамида тестов: юнит -> интеграционные -> E2E
- Дополнительно: нагрузочные тесты на locust
- Инструменты: pytest (современный стандарт) vs unittest (база, но legacy), conftest.py для фикстур
- Тестирование API: Postman (ручное тестирование, прототипирование) vs requests (автоматизация в коде, CI/CD)
